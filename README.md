## Online_Assessment_Platform_Backend
...
```bash
git clone https://github.com/Ravichandran-D/online-assessment-platform-backend.git
cd backend
```
...
```bash
MONGO_URI=MONGO_URI=mongodb+srv://<username>:<password>@<cluster>.mongodb.net/assessment-platform
